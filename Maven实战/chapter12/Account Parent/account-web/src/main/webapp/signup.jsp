...
<body>
	...
	<div class="text-field">
		...
		<form name="signup" action="signup" method="post">
			<label>账户ID：</label><input type="text" name="id"></input><br /> <label>Email：</label><input
				...
				type="password" name="confirm_password"></input><br /> <label>验证码：</label><input
				type="text" name="captcha_value"></input><br /> <input
